...
public class Logic 
    ...
    static double rightTriangleArea(double base, double height) {
        return (base * height) / 2;
    }

    static double rightTrianglePerimeter(double base, double height) {
        double hypotenuse = sqrt(square(base) + square(height));
        return hypotenuse + base + height;
    }

    static double boxVolume(double length, double width, double depth) {
        return length * width * depth;
    }

    static double boxSurfaceArea(double length, double width, double depth) {
        double ab = length * width;
        double ac = length * depth;
        double bc = width * depth;
